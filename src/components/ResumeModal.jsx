        ...
        <head>
          ...
          <style>
            ...
            * { box-sizing: border-box; margin: 0; padding: 0; }
            ...
            h1 { font-family: 'Outfit', sans-serif; font-size: 24px; font-weight: 800; color: #0284c7 !important; letter-spacing: -0.5px; margin-bottom: 2px; }
            h2, h3 { font-family: 'Outfit', sans-serif; font-weight: 700; font-size: 11.5px; color: #0284c7 !important; letter-spacing: 0.04em; margin-bottom: 4px; margin-top: 9px; border-bottom: 1.5px solid #cbd5e1; padding-bottom: 2px; }
            ...
            .space-y-3 > * + * { margin-top: 9px; }
            .space-y-3\\.5 > * + * { margin-top: 11px; }
            .space-y-4 > * + * { margin-top: 13px; }
            ...
            .p-2\\.5, .p-3, .p-3\\.5 { padding: 8px 10px; }
            .p-5, .p-6, .sm\\:p-7 { padding: 11px; }
            .pb-3, .pb-3\\.5 { padding-bottom: 7px; margin-bottom: 7px; }
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950/85 backdrop-blur-xl flex items-center justify-center p-3 sm:p-5 overflow-y-auto">
      <div className="bg-slate-900 border border-slate-800 rounded-3xl max-w-4xl w-full max-h-[92vh] overflow-y-auto p-4 sm:p-6 space-y-4 shadow-2xl relative animate-in fade-in zoom-in-95 duration-200 scrollbar-thin">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <span className="px-2 py-0.5 rounded text-[9px] font-mono bg-cyan-950 text-cyan-400 border border-cyan-800/50 uppercase tracking-wider font-bold">
                EXECUTIVE RESUME • PERFECT 1-PAGE A4 FORMAT
              </span>
        ...
        {/* Printable Executive Resume Container (Perfect 1-Page Layout) */}
        <div
          id="printable-resume"
          className="bg-slate-950/80 border border-slate-800/80 rounded-2xl p-4 sm:p-5 space-y-3 text-slate-200 font-sans shadow-inner"
        >
          {/* Header Section */}
            ...
            <div className="space-y-2">
              ...
              <div className="p-2.5 rounded-xl bg-slate-900/90 border border-slate-800 space-y-1">
                ...
                <ul className="list-disc list-inside space-y-0.5 text-xs text-slate-300 leading-snug">
                  <li>Architecting scalable server-side backend infrastructure for AI applications using Node.js & Express.</li>
                  <li>Designing strict API contracts, data pipelines, RAG systems, and structured JSON output parsers for local LLMs (Ollama).</li>
                </ul>
              </div>
